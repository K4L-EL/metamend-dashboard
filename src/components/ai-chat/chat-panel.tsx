      ...
      {open && (
        <div className="fixed bottom-20 right-6 z-50 flex h-[480px] w-[360px] flex-col rounded-2xl border border-neutral-200 bg-white shadow-2xl">
          ...
          <div className="flex items-center gap-3 border-b border-neutral-200 px-4 py-3">
            ...
            <div>
              <h3 className="text-[13px] font-semibold text-neutral-900">MetaMed AI</h3>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {messages.length === 0 ? (
              <div className="space-y-3">
                <div className="flex items-center gap-2 rounded-xl bg-teal-50 p-3">
                ...
                <div className="space-y-1.5">
                  {WELCOME_SUGGESTIONS.map((s) => (
                    <button
                      ...
                      className="w-full rounded-lg border border-neutral-200 px-3 py-2 text-left text-[12px] text-neutral-600 transition-colors hover:border-teal-300 hover:bg-teal-50"
                    >
                      {s}
                    </button>
                  ))}
          ...
          <div className="border-t border-neutral-200 p-3">
            ...
            >
              <input
                ...
                className="flex-1 rounded-lg border border-neutral-200 bg-neutral-50 px-3 py-2 text-[12px] text-neutral-900 outline-none placeholder:text-neutral-400 focus:border-teal-300"
              />
              <button
                type="submit"
                disabled={!input.trim()}
