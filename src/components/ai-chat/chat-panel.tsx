                ...
                <div className="space-y-1.5">
                  {WELCOME_SUGGESTIONS.map((s) => (
                    <button
                      ...
                      className="w-full rounded-lg border border-neutral-200 px-3 py-2 text-left text-[12px] text-neutral-600 transition-colors hover:border-sky-300 hover:bg-sky-50"
                    >
                      {s}
                    </button>
                  ))}
          ...
          <div className="border-t border-neutral-200 p-3">
            ...
            >
              <input
                ...
                className="flex-1 rounded-lg border border-neutral-200 bg-neutral-50 px-3 py-2 text-[12px] text-neutral-900 outline-none placeholder:text-neutral-400 focus:border-sky-300"
              />
              <button
                type="submit"
                disabled={!input.trim()}
