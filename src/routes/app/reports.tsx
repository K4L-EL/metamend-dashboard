      ...
      <div className="flex h-full items-center justify-center p-8">
        <div className="max-w-lg text-center">
          ...
          <p className="mb-2 text-sm text-neutral-500">
            ...
            inspired by national reports for IPC published annually across UK
            and EU countries. The report includes detailed charts, data tables,
            and AI-generated analysis across all domains.
          </p>
      ...
      <div ref={reportRef} className="mx-auto max-w-[900px] px-6 py-8 print:max-w-none print:px-0">
        ...
        <div className="mt-10 border-t border-neutral-200 pt-6 text-center print:mt-4">
          <p className="text-[10px] text-neutral-400">
            ...
            surveillance system. Report format inspired by national reports for
            IPC published annually across UK and EU countries.
          </p>
